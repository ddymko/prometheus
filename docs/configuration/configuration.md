...
Vultr SD configurations allow retrieving scrape targets from [Vultr's](https://www.vultr.com/) Vultr APIv2
This service discovery uses the main IPv4 address by default, by that can be
...
* `__meta_vultr_instance_allowed_bandwidth` : Monthly bandwidth quota in GB.
